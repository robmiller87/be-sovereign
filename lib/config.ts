/**
 * Configuration for Declaration of Digital Independence
 * 
 * Environment variables:
 * - SPACE_ID: Space ID for data isolation (default: 'declaration')
 * - ARKIV_PRIVATE_KEY: Private key for signing transactions (required for writes)
 */

export const SPACE_ID = process.env.SPACE_ID || process.env.BETA_SPACE_ID || 'declaration';
